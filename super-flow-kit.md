...
| 暂不实现内容                                      | 推迟原因                                                      |
| ------------------------------------------------- | ------------------------------------------------------------- |
| `/sfk-export` 导出 ZIP                            | 需要额外文件打包逻辑，可在状态和产出物稳定后实现。            |
| `/sfk-code-review`                                | 与核心工作流状态管理关系较弱，适合后续作为增强能力。          |
...
| `/sfk-export`               | 远期        | 导出状态和产出物。                   |
| `/sfk-reset`                | 远期/高风险 | 重置项目工作流状态，必须二次确认。   |
| `/sfk-code-review`          | 远期        | 代码审查增强能力。                   |
